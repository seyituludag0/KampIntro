...
namespace Reflection
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(dortIslem.Topla(6, 8));


            var type = typeof(DortIslem);
            //DortIslem dortIslem = (DortIslem) Activator.CreateInstance(type, 8,4);
            //Console.WriteLine(dortIslem.Topla(2, 4));
            //Console.WriteLine(dortIslem.Topla2());

            var instance = (DortIslem)Activator.CreateInstance(type, 8, 4);
